...
public class AboutFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        DrawerLayout drawerLayout = requireView().findViewById(R.id.aboutFragment_drawer);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (id) {
                    ...
                    case R.id.contactFragment:
                        Navigation.findNavController(view).navigate(R.id.action_aboutFragment_to_contactFragment);
                        break;
                    case R.id.restaurantsFragmment:
                        Navigation.findNavController(view).navigate(R.id.action_aboutFragment_to_restaurantsFragment);
                        break;
                    default:
                        return true;
                }
